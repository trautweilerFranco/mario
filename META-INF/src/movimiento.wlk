...
object moves {
	...
	method config() {
		keyboard.left().onPressDo{ izquierda.move(mario)}
		keyboard.right().onPressDo{ derecha.move(mario)}
		keyboard.up().onPressDo{ arriba.move(mario)}
		keyboard.down().onPressDo{ abajo.move(mario)}
		keyboard.a().onPressDo{ izquierda.move(mario)}
		keyboard.d().onPressDo{ derecha.move(mario)}
		keyboard.w().onPressDo{ arriba.move(mario)}
		keyboard.s().onPressDo{ abajo.move(mario)}
	}
